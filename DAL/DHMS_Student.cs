...
namespace DHMSClass.DAL
{
	...
	public partial class DHMS_Student
	{
		...
		public bool Exists(string Student_Sno)
		{
			...
			strSql.Append("select count(1) from DHMS_Student");
			strSql.Append(" where Student_Sno='"+Student_Sno+"' ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DHMS_Student ");
		...
		public bool Delete(string Student_Sno)
		{
			...
			SqlParameter[] parameters = {
					new SqlParameter("@Student_Sno", SqlDbType.VarChar,-1)};
			parameters[0].Value = Student_Sno;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Student_ID,Student_Sno,Student_Name,Student_Sex,Student_Birthday,Student_Num,Department_ID,Class_ID ");
			strSql.Append(" FROM DHMS_Student ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DHMS_Student T ");
