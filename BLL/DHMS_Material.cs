...
namespace DHMSClass.BLL
{
	...
	{
		private readonly DHMSClass.DAL.DHMS_Material dal=new DHMSClass.DAL.DHMS_Material();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DHMSClass.Model.DHMS_Material GetModelByCache(string Material_ID)
		{
			
			string CacheKey = "DHMS_MaterialModel-" + Material_ID;
			...
			return (DHMSClass.Model.DHMS_Material)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DHMSClass.Model.DHMS_Material> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DHMSClass.Model.DHMS_Material> DataTableToList(DataTable dt)
		{
			List<DHMSClass.Model.DHMS_Material> modelList = new List<DHMSClass.Model.DHMS_Material>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DHMSClass.Model.DHMS_Material model;
