...
namespace DHMSClass.BLL
{
	...
	{
		private readonly DHMSClass.DAL.DHMS_Department dal=new DHMSClass.DAL.DHMS_Department();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DHMSClass.Model.DHMS_Department GetModelByCache(string Department_ID)
		{
			
			string CacheKey = "DHMS_DepartmentModel-" + Department_ID;
			...
			return (DHMSClass.Model.DHMS_Department)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DHMSClass.Model.DHMS_Department> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DHMSClass.Model.DHMS_Department> DataTableToList(DataTable dt)
		{
			List<DHMSClass.Model.DHMS_Department> modelList = new List<DHMSClass.Model.DHMS_Department>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DHMSClass.Model.DHMS_Department model;
