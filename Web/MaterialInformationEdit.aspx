<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialInformationEdit.aspx.cs" Inherits="DHMSClass.Web.MaterialInformationEdit" %>
                ...
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <form id="Form1" class="form-horizontal" runat="server">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">物资单位</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_MUnit" runat="server" class="form-control" placeholder="物资单位"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">物资产地</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_MPlace" runat="server" class="form-control" placeholder="物资产地"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">物资合格证</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_MCertificate" runat="server" class="form-control" placeholder="物资合格证"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="example-email">物资采购日期 *</label>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txt_MPDateTime" runat="server" class="form-control" placeholder="物资采购日期(yyyy-MM-dd)"></asp:TextBox>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="example-email">物资有效日期 *</label>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txt_MEDateTime" runat="server" class="form-control" placeholder="物资有效日期(yyyy-MM-dd)"></asp:TextBox>
                                        </div>
                                    </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">物资使用方法</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_MMethod" runat="server" class="form-control" placeholder="物资使用方法"></asp:TextBox>
                                </div>
                            </div>
