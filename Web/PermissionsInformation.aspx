<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermissionsInformation.aspx.cs" Inherits="DHMSClass.Web.PermissionsInformation" %>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="PermissionsInformationEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                ...
                <HeaderTemplate>
                    <table class="display table" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
                        <tr>
                            ...
                            <th style="text-align:center">权限简介</th>
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("Permissions_ID")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("Permissions_Name")%></td>
                        <td align="center"><%#Eval("Permissions_Introduction")%></td>
                        <td class="text-center">
                            <div>
                                <a href="PermissionsInformationEdit.aspx?action=Edit&id=<%#Eval("Permissions_ID")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
