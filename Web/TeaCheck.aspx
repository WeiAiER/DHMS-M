<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeaCheck.aspx.cs" Inherits="DHMSClass.Web.TeaCheck" %>
    ...
    <div class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="page-title-box">
                <h4 class="page-title">教工晨午检信息</h4>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="TeaCheckEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("TeaCheck_ID")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("Teacher_Name")%></td>
                        <td align="center"><%#Eval("TeaCheck_Term")%></td>
                        <td align="center"><%#Eval("TeaCheck_Date")%></td>
                        <td align="center"><%#Eval("TeaCheck_Stage")%></td>
                        <td align="center"><%#Eval("TeaCheck_Remarks")%></td>
                        <td class="text-center">
                            <div id="NoPrint">
                                <a href="TeaCheckEdit.aspx?action=Edit&id=<%#Eval("TeaCheck_ID")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
