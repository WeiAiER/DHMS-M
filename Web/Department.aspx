<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="Department.aspx.cs" Inherits="DHMSClass.Web.Department" %>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="DepartmentEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                        ...
                        <div style="width:100px;float:left">
                                    <asp:Button ID="Button1" runat="server" class="btn btn-inverse" Text="导出系部表" OnClick="Button1_Click"></asp:Button>
                                </div>
                </div>
                ...
                <HeaderTemplate>
                    <table class="display table" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
                        <tr>
                            ...
                            <th style="text-align:center">系部负责人</th>
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("Department_ID")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("Department_Name")%></td>
                         <td align="center"><%#Eval("Teacher_Name")%></td>
                     
                        <td class="text-center">
                            <div>
                                <a href="DepartmentEdit.aspx?action=Edit&id=<%#Eval("Department_ID")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
