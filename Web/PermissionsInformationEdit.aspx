<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermissionsInformationEdit.aspx.cs" Inherits="DHMSClass.Web.PermissionsInformationEdit" %>
    ...
    <div class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h2 class="header-title">权限详情</h2>
                        <form id="Form1" class="form-horizontal" runat="server">
                            <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">权限名称</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="Permissions_Name" runat="server" class="form-control" placeholder="权限名称"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">权限简介</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="Permissions_Introduction" runat="server" class="form-control" placeholder="权限简介"></asp:TextBox>
                                </div>
                            </div>
