<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EpidemicDaily.aspx.cs" Inherits="DHMSClass.Web.EpidemicDaily" %>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="EpidemicDailyEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                ...
                <HeaderTemplate>
                    <table class="display table" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
                        <tr>
                            ...
                            <th style="text-align:center">问题回答</th>
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("Daily_ID ")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("Teacher_Name")%></td>
                        <td align="center"><%#Eval("Investigation_Problem")%></td>
                        <td align="center"><%#Eval("Daily_Reply")%></td>
                        <td align="center"><%#Eval("Daily_DateTime")%></td>
                        <td class="text-center">
                            <div>
                                <a href="EpidemicDailyEdit.aspx?action=Edit&id=<%#Eval("Daily_ID")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
