...
namespace DHMSClass.Web
{
    public partial class Teacher : System.Web.UI.Page
    {
        ...
        private void RptBind(string strWhere)
        {
            ...
            //用Linq语句实现对部门表的模糊查询
            var result = from r in dt_Teacher.AsEnumerable()
                         join g in dt_Departments.AsEnumerable() on r.Field<string>("Department_ID") equals g.Field<string>("Department_ID")
                         where r.Field<string>("Teacher_Name").Contains(strWhere) || r.Field<string>("Teacher_Sex").Contains(strWhere)
                         select new
                         {
                             Teacher_Tno = r.Field<dynamic>("Teacher_Tno"),
                             Teacher_Name = r.Field<string>("Teacher_Name"),
                             Teacher_Sex = r.Field<string>("Teacher_Sex"),
                             Teacher_Birthday = r.Field<DateTime>("Teacher_Birthday"),
                             Teacher_Num = r.Field<string>("Teacher_Num"),
            ...
            string pageUrl = Utils.CombUrlTxt("Teacher.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("Teacher.aspx", "keywords={0}", txtKeywords.Text));//跳转页面，并携带keywords
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("Teacher.aspx", "keywords={0}", this.keywords));
        }
        #endregion
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            Alert.AlertAndRedirect("删除成功！", Utils.CombUrlTxt("Teacher.aspx", "keywords={0}", this.keywords));
        }
        ...
        private bool Delete(long id)
        {
            ...
            try
            {
                if (!bll_Teacher.Delete(id.ToString()))
                {
                    return false;
                }
                return true;
