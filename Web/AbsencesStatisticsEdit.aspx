<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AbsencesStatisticsEdit.aspx.cs" Inherits="DHMSClass.Web.AbsencesStatisticsEdit" %>
    ...
    <div class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h2 class="header-title">缺课信息详情</h2>
                        <form id="Form1" class="form-horizontal" runat="server">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">是否发热 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Fever" runat="server" class="form-control" placeholder="是否发热"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">症状</label>
                                <div class="col-md-10">
                                    <asp:DropDownList ID="ddl_Sym" runat="server" class="form-control"></asp:DropDownList>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">诊断</label>
                                <div class="col-md-10">
                                    <asp:DropDownList ID="ddl_Dia" runat="server" class="form-control"></asp:DropDownList>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">就诊状态</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_MState" runat="server" class="form-control" placeholder="就诊状态"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">就诊医院</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_MHospital" runat="server" class="form-control" placeholder="就诊医院"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">缺课天数 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_MDays" runat="server" class="form-control" placeholder="缺课天数"></asp:TextBox>
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">缺课课时 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_MHourClass" runat="server" class="form-control" placeholder="缺课课时"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">缺课类型 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_MType" runat="server" class="form-control" placeholder="缺课类型"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">流行病学</label>
                                <div class="col-md-10">
                                    <asp:DropDownList ID="ddl_Epi" runat="server" class="form-control"></asp:DropDownList>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">报告人 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_TName" runat="server" class="form-control" placeholder="报告人"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="example-email">报告日期</label>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txt_ReportDate" runat="server" class="form-control" placeholder="报告日期(yyyy-MM-dd)"></asp:TextBox>
                                        </div>
                                    </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
