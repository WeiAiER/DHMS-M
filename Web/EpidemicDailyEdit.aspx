<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EpidemicDailyEdit.aspx.cs" Inherits="DHMSClass.Web.EpidemicDailyEdit" %>
    ...
    <div class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h2 class="header-title">疫情日报详情</h2>
                        <form id="Form1" class="form-horizontal" runat="server">
                            <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">教师姓名 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_TName" runat="server" class="form-control" placeholder="教师姓名"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">问题内容 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_IProblem" runat="server" class="form-control" placeholder="问题内容"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">问题回答 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_DailyReply" runat="server" class="form-control" placeholder="问题回答"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txt_DailyDate" runat="server" class="form-control" placeholder="日期(yyyy-MM-dd)"></asp:TextBox>
                                        </div>
                                    </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
