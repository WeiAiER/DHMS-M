<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AbsencesStatistics.aspx.cs" Inherits="DHMSClass.Web.AbsencesStatistics" %>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="AbsencesStatisticsEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                ...
                <HeaderTemplate>
                    <table class="display table" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
                        <tr>
                            ...
                            <th style="text-align:center">是否发热</th>
                            <th style="text-align:center">症状</th>
                            <th style="text-align:center">诊断</th>
                            <th style="text-align:center">就诊状态</th>
                            <th style="text-align:center">就诊医院</th>
                            <th style="text-align:center">缺课天数</th>
                            <th style="text-align:center">缺课课时</th>
                            <th style="text-align:center">缺课类型</th>
                            <th style="text-align:center">流行病学</th>
                            <th style="text-align:center">报告人</th>
                            <th style="text-align:center">报告日期</th>
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("Miss_ID")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("Student_Name")%></td>
                        <td align="center"><%#Eval("Miss_Fever")%></td>
                        <td align="center"><%#Eval("Symptom_Name")%></td>
                        <td align="center"><%#Eval("Diagnosis_Name")%></td>
                        <td align="center"><%#Eval("Miss_MState")%></td>
                        <td align="center"><%#Eval("Miss_MHospital")%></td>
                        <td align="center"><%#Eval("Miss_Days")%></td>
                        <td align="center"><%#Eval("Miss_ClassHour")%></td>
                        <td align="center"><%#Eval("Miss_Type")%></td>
                        <td align="center"><%#Eval("Epidemic_Name")%></td>
                        <td align="center"><%#Eval("Teacher_Name")%></td>
                        <td align="center"><%#Eval("Miss_RDateTime")%></td>
                        <td class="text-center">
                            <div>
                                <a href="AbsencesStatisticsEdit.aspx?action=Edit&id=<%#Eval("Miss_ID")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
