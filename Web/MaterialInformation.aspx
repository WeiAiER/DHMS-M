<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialInformation.aspx.cs" Inherits="DHMSClass.Web.MaterialInformation" %>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="MaterialInformationEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                ...
                <HeaderTemplate>
                    <table class="display table" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
                        <tr>
                            ...
                            <th style="text-align:center">物资规格</th>
                            <th style="text-align:center">物资单位</th>
                            <th style="text-align:center">物资产地</th>
                            <th style="text-align:center">物资合格证</th>
                            <th style="text-align:center">物资采购日期</th>
                            <th style="text-align:center">物资有效日期</th>
                            <th style="text-align:center">物资使用方法</th>
                            <th style="text-align:center">查看库存量和总量</th>
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("Material_ID")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("Material_Name")%></td>
                        <td align="center"><%#Eval("Material_Specs")%></td>
                        <td align="center"><%#Eval("Material_Unit")%></td>
                        <td align="center"><%#Eval("Material_Place")%></td>
                        <td align="center"><%#Eval("Material_Certificate")%></td>
                        <td align="center"><%#Eval("Material_PDateTime")%></td>
                        <td align="center"><%#Eval("Material_EDateTime")%></td>
                        <td align="center"><%#Eval("Material_Method")%></td>
                        <td class="text-center">
                            <div>
                                <a href="MaterialSelect.aspx?action=Select&id=<%#Eval("Material_ID")%>">&nbsp;查看&nbsp;</a>
                            </div> 
                        </td>
                        <td class="text-center">
                            <div>
                                <a href="MaterialInformationEdit.aspx?action=Edit&id=<%#Eval("Material_ID")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
