<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeaCheckEdit.aspx.cs" Inherits="DHMSClass.Web.TeaCheckEdit" %>
    ...
    <div class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h2 class="header-title">教工晨午检详情</h2>
                        <form id="Form1" class="form-horizontal" runat="server">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">学期 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Term" runat="server" class="form-control" placeholder="学期"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">日期 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Date" runat="server" class="form-control" placeholder="日期(yyyy-MM-dd)"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">阶段 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Stage" runat="server" class="form-control" placeholder="阶段"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">备注</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Remarks" runat="server" class="form-control" placeholder="备注"></asp:TextBox>
                                </div>
                            </div>
