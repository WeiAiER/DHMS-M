<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BoarderManageEdit.aspx.cs" Inherits="DHMSClass.Web.BoarderManageEdit" %>
    ...
    <div class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h2 class="header-title">住宿生管理详情</h2>
                        <form id="Form1" class="form-horizontal" runat="server">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_date" runat="server" class="form-control" placeholder="日期"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">回宿时间</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_BoarderManage_RTime" runat="server" class="form-control" placeholder="回宿时间"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">晚检反馈</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_BoarderManage_Feedback" runat="server" class="form-control" placeholder="晚检反馈"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">晚检时间</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_BoarderManage_NTime" runat="server" class="form-control" placeholder="晚检时间"></asp:TextBox>
                                </div>
                            </div>
