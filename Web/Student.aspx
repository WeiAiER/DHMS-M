<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="DHMSClass.Web.Student" %>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="StudentEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("Student_Sno")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("Student_Name")%></td>
                        <td align="center"><%#Eval("Student_Sex")%></td>
                        <td align="center"><%#Eval("Student_Birthday")%></td>
                        <td align="center"><%#Eval("Student_Num")%></td>
                        <td align="center"><%#Eval("Department_Name")%></td>
                        <td align="center"><%#Eval("Class_Name")%></td>
                        <td class="text-center">
                            <div id="NoPrint">
                                <a href="StudentEdit.aspx?action=Edit&id=<%#Eval("Student_Sno")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
