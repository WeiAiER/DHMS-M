<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialSelect.aspx.cs" Inherits="DHMSClass.Web.MaterialSelect" %>
    ...
    <div class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h2 class="header-title">物资库存量和总量</h2>
                        <form id="Form1" class="form-horizontal" runat="server">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">物资库存量</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_MStock" runat="server" class="form-control" placeholder="物资库存量"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">物资总量</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_MCount" runat="server" class="form-control" placeholder="物资总量"></asp:TextBox>
                                </div>
                            </div>
