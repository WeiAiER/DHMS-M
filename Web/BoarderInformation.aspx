<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="BoarderInformation.aspx.cs" Inherits="DHMSClass.Web.BoarderInformation" %>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="BoarderInformationEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("Boarder_ID")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("Student_Name")%></td>
                        <td align="center"><%#Eval("Boarder_HostelNum")%></td>
                     
                        <td class="text-center">
                            <div>
                                <a href="BoarderInformationEdit.aspx?action=Edit&id=<%#Eval("Boarder_ID")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
