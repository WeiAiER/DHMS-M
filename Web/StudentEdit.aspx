<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentEdit.aspx.cs" Inherits="DHMSClass.Web.StudentEdit" %>
    ...
    <div class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h2 class="header-title">学生信息详情</h2>
                        <form id="Form1" class="form-horizontal" runat="server">
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">学生姓名 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Name" runat="server" class="form-control" placeholder="学生姓名"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">学生性别 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Sex" runat="server" class="form-control" placeholder="学生性别"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">出生日期 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Birthday" runat="server" class="form-control" placeholder="出生日期(yyyy-MM-dd)"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">电话号码</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Num" runat="server" class="form-control" placeholder="电话号码"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">所属系部 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Department" runat="server" class="form-control" placeholder="所属系部"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">所在班级 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Class" runat="server" class="form-control" placeholder="所在班级"></asp:TextBox>
                                </div>
                            </div>
