<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="Class.aspx.cs" Inherits="DHMSClass.Web.Class" %>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="ClassEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                        ...
                        <div style="width:100px;float:left">
                                    <asp:Button ID="Button1" runat="server" class="btn btn-inverse" Text="导出班级表" OnClick="Button1_Click"></asp:Button>
                                </div>
                </div>
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("Class_ID")%>' runat="server" />
                        </td>
                        ...
                        <td class="text-center">
                            <div>
                                <a href="ClassEdit.aspx?action=Edit&id=<%#Eval("Class_ID")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
