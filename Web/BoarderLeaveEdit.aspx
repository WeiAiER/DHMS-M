<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BoarderLeaveEdit.aspx.cs" Inherits="DHMSClass.Web.BoarderLeaveEdit" %>
    ...
    <div class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h2 class="header-title">住宿生请假详情</h2>
                        <form id="Form1" class="form-horizontal" runat="server">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">请假原因</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Reason" runat="server" class="form-control" placeholder="请假原因"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">审核人 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Auditor" runat="server" class="form-control" placeholder="审核人"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">状态</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_State" runat="server" class="form-control" placeholder="状态"></asp:TextBox>
                                </div>
                            </div>
