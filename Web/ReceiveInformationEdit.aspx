<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiveInformationEdit.aspx.cs" Inherits="DHMSClass.Web.ReceiveInformationEdit" %>
                    ...
                    <div class="white-box">
                        ...
                        <form id="Form1" class="form-horizontal" runat="server">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <asp:DropDownList ID="ddl_MName" runat="server" class="form-control"></asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_TName" runat="server" class="form-control" placeholder="领用人"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="example-email">领用日期 *</label>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txt_RDateTime" runat="server" class="form-control" placeholder="领用日期(yyyy-MM-dd)"></asp:TextBox>
                                        </div>
                                    </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
