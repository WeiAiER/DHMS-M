<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiveInformation.aspx.cs" Inherits="DHMSClass.Web.ReceiveInformation" %>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="ReceiveInformationEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("Receive_ID")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("Material_Name")%></td>
                        <td align="center"><%#Eval("Teacher_Name")%></td>
                        <td align="center"><%#Eval("Receive_Number")%></td>
                        <td align="center"><%#Eval("Receive_DateTime")%></td>
                        <td class="text-center">
                            <div>
                                <a href="ReceiveInformationEdit.aspx?action=Edit&id=<%#Eval("Receive_ID")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
