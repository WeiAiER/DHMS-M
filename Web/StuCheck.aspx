<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StuCheck.aspx.cs" Inherits="DHMSClass.Web.StuCheck" %>
    ...
    <div class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="page-title-box">
                <h4 class="page-title">学生晨午检信息</h4>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="StuCheckEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
            ...
            <!--/工具栏-->
            <!--列表-->
                                <div class="row"><div class="col-sm-12" id="print">
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("StuCheck_ID")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("Student_Name")%></td>
                        <td align="center"><%#Eval("StuCheck_Term")%></td>
                        <td align="center"><%#Eval("StuCheck_Date")%></td>
                        <td align="center"><%#Eval("StuCheck_Stage")%></td>
                        <td align="center"><%#Eval("StuCheck_Remarks")%></td>
                        <td class="text-center">
                            <div id="NoPrint">
                                <a href="StuCheckEdit.aspx?action=Edit&id=<%#Eval("StuCheck_ID")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
