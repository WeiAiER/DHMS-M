<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherEdit.aspx.cs" Inherits="DHMSClass.Web.TeacherEdit" %>
        ...
        <div class="main-content">
            ...
            <div class="wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h2 class="header-title">教师信息详情</h2>
                            <form id="Form1" class="form-horizontal" runat="server">
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="example-email">教师姓名 *</label>
                                    <div class="col-md-10">
                                        <asp:TextBox ID="txt_Name" runat="server" class="form-control" placeholder="教师姓名"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="example-email">教师性别 *</label>
                                    <div class="col-md-10">
                                        <asp:TextBox ID="txt_Sex" runat="server" class="form-control" placeholder="教师性别"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
