<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="BoarderManage.aspx.cs" Inherits="DHMSClass.Web.BoarderManage" %>
    ...
    <div class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="page-title-box">
                <h4 class="page-title">住宿生管理信息</h4>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="BoarderManageEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                ...
                <HeaderTemplate>
                    <table class="display table" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
                        <tr>
                            ...
                            <th style="text-align:center">回宿时间</th>
                            <th style="text-align:center">晚检反馈</th>
                            <th style="text-align:center">晚检时间</th>
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("BoarderManage_ID")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("Student_Name")%></td>
                        <td align="center"><%#Eval("BoarderManage_Date")%></td>
                         <td align="center"><%#Eval("BoarderManage_RTime")%></td>
                         <td align="center"><%#Eval("BoarderManage_Feedback")%></td>
                         <td align="center"><%#Eval("BoarderManage_NTime")%></td>
                        <td class="text-center">
                            <div>
                                <a href="BoarderManageEdit.aspx?action=Edit&id=<%#Eval("BoarderManage_ID")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
