...
namespace DHMSClass.Web
{
    public partial class Class : System.Web.UI.Page
    {
        ...
        DHMSClass.BLL.DHMS_Class Class1 = new BLL.DHMS_Class();
        ...
        private void RptBind(string strWhere)
        {
            ...
            DataTable dt_Class = Class1.GetList("").Tables[0];
            ...
            //用Linq语句实现对部门表的模糊查询
            var result = from p in dt_Class.AsEnumerable()
                         join g in dt_Teacher.AsEnumerable() on p.Field<string>("Teacher_Tno") equals g.Field<string>("Teacher_Tno")
                         join r in dt_Department.AsEnumerable() on p.Field<string>("Department_ID") equals r.Field<string>("Department_ID")
                         where p.Field<string>("Class_Name").Contains(strWhere)
                         select new
                         {
                             Class_ID = p.Field<string>("Class_ID"),
                             Class_Name = p.Field<string>("Class_Name"),
            ...
            string pageUrl = Utils.CombUrlTxt("Class.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            Alert.AlertAndRedirect("删除成功！", Utils.CombUrlTxt("Class.aspx", "keywords={0}", this.keywords));
        ...
        private bool Delete(long id)
        {
            ...
            DataSet ds_Purchase = Class1.GetList("Class_ID = '" + id.ToString() + "'");
            try
            {
                if (!Class1.Delete(id.ToString()))
                {
                    return false;
                }
                return true;
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("Class.aspx", "keywords={0}", this.keywords));
        }

        protected void btnSearch_Click(object sender, EventArgs e)
        {
            Response.Redirect(Utils.CombUrlTxt("Class.aspx", "keywords={0}", txtKeywords.Text));//跳转页面，并携带keywords
        }
