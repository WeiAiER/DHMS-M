<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseInformationEdit.aspx.cs" Inherits="DHMSClass.Web.PurchaseInformationEdit" %>
    ...
    <div class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h2 class="header-title">物资采购详情</h2>
                        <form id="Form1" class="form-horizontal" runat="server">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">采购数量 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_PNumber" runat="server" class="form-control" placeholder="采购数量"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="example-email">采购日期 *</label>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txt_PPDateTime" runat="server" class="form-control" placeholder="采购日期(yyyy-MM-dd)"></asp:TextBox>
                                        </div>
                                    </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">采购人 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_TName" runat="server" class="form-control" placeholder="采购人"></asp:TextBox>
                                </div>
                            </div>
