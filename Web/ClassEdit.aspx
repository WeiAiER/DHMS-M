<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClassEdit.aspx.cs" Inherits="DHMSClass.Web.ClassEdit" %>
    ...
    <div class="main-content">
                ...
                <ul class="notification-menu">
                    ...
                    <li>
                        <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            ...
                            <asp:Label ID="Label1" runat="server" class="page-title" Text="用户名"></asp:Label>
        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h2 class="header-title">班级详情</h2>
                        <form id="Form2" class="form-horizontal" runat="server">
                            <asp:ScriptManager ID="ScriptManager2" runat="server"></asp:ScriptManager>
                            
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">班级名称 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Name" runat="server" class="form-control" placeholder="班级名称"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">班主任 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Teacher" runat="server" class="form-control" placeholder="班主任"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-b-0">
                                <div class="col-sm-offset-3 col-sm-9">
                                    <asp:Button ID="Button1" runat="server" Text="确定" class="btn btn-primary" OnClick="btn_Confirm_Click" />
                                </div>
                            </div>
