<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentEdit.aspx.cs" Inherits="DHMSClass.Web.DepartmentEdit" %>
    ...
    <div class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h2 class="header-title">系部详情</h2>
                        <form id="Form1" class="form-horizontal" runat="server">
                            <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                            
                          <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">系部名称 *</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Department" runat="server" class="form-control" placeholder="系部名称"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="example-email">系部负责人</label>
                                <div class="col-md-10">
                                    <asp:TextBox ID="txt_Teacher" runat="server" class="form-control" placeholder="系部负责人"></asp:TextBox>
                                </div>
                            </div>
