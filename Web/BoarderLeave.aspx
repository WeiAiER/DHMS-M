<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="BoarderLeave.aspx.cs" Inherits="DHMSClass.Web.BoarderLeave" %>
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li class="menu-list nav-active"><a href="#"><i class="icon-pie-chart"></i><span>晨午检总览</span></a>
                    <ul class="sub-menu-list">
                        <li class="active"><a href="StuCheck.aspx">学生晨午检信息</a></li>
                    </ul>
                    <ul class="sub-menu-list">
                        <li class="active"><a href="TeaCheck.aspx">教工晨午检信息</a></li>
                    </ul>
                </li>
            </ul>
    ...
    <div class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="page-title-box">
                <h4 class="page-title">住宿生请假信息</h4>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="BoarderLeaveEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("BoarderLeave_ID")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("BoarderLeave_Date")%></td>
                         <td align="center"><%#Eval("BoarderLeave_Reason")%></td>
                         <td align="center"><%#Eval("BoarderLeave_Auditor")%></td>
                         <td align="center"><%#Eval("BoarderLeave_State")%></td>
                     
                        <td class="text-center">
                            <div>
                                <a href="BoarderLeaveEdit.aspx?action=Edit&id=<%#Eval("BoarderLeave_ID")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
