<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseInformation.aspx.cs" Inherits="DHMSClass.Web.PurchaseInformation" %>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="PurchaseInformationEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                ...
                <HeaderTemplate>
                    <table class="display table" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
                        <tr>
                            ...
                            <th style="text-align:center">领用操作</th>
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("Purchase_ID")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("Material_Name")%></td>
                        <td align="center"><%#Eval("Purchase_Number")%></td>
                        <td align="center"><%#Eval("Purchase_DateTime")%></td>
                        <td align="center"><%#Eval("Teacher_Name")%></td>
                        <td class="text-center">
                            <div>
                                <a href="PurchaseInformationEdit.aspx?action=Edit&id=<%#Eval("Purchase_ID")%>">&nbsp;领用&nbsp;</a>
                            </div> 
                        </td>
                        <td class="text-center">
                            <div>
                                <a href="PurchaseInformationEdit.aspx?action=Edit&id=<%#Eval("Purchase_ID")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
