<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Teacher.aspx.cs" Inherits="DHMSClass.Web.Teacher" %>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="TeacherEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-inverse" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("Teacher_Tno")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("Teacher_Name")%></td>
                        <td align="center"><%#Eval("Teacher_Sex")%></td>
                        <td align="center"><%#Eval("Teacher_Birthday")%></td>
                        <td align="center"><%#Eval("Teacher_Num")%></td>
                        <td align="center"><%#Eval("Department_Name")%></td>
                        <td class="text-center">
                            <div id="NoPrint">
                                <a href="TeacherEdit.aspx?action=Edit&id=<%#Eval("Teacher_Tno")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
